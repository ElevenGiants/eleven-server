...
var Add, All, Any, Append, Args, Asc, Avg, Between, Binary, Branch, ChangeAt, Changes, CoerceTo, ConcatMap, Contains, Count, DatumTerm, Day, DayOfWeek, DayOfYear, Db, DbCreate, DbDrop, DbList, Default, Delete, DeleteAt, Desc, Difference, Distinct, Div, Downcase, During, EpochTime, Eq, EqJoin, Filter, ForEach, FunCall, Func, Ge, Get, GetAll, GetField, Group, Gt, HasFields, Hours, Http, ISO8601, ImplicitVar, InTimezone, IndexCreate, IndexDrop, IndexList, IndexRename, IndexStatus, IndexWait, IndexesOf, Info, InnerJoin, Insert, InsertAt, IsEmpty, JavaScript, Json, Keys, Le, Limit, Literal, Lt, MakeArray, MakeObject, Map, Match, Max, Merge, Min, Minutes, Mod, Month, Mul, Ne, Not, Now, Nth, Object_, OrderBy, OuterJoin, Pluck, Prepend, Promise, RDBOp, RDBVal, RQLDate, Random, Reduce, Replace, Sample, Seconds, SetDifference, SetInsert, SetIntersection, SetUnion, Skip, Slice, SpliceAt, Split, Sub, Sum, Sync, Table, TableCreate, TableDrop, TableList, TermBase, Time, TimeOfDay, Timezone, ToEpochTime, ToISO8601, TypeOf, Ungroup, Union, Upcase, Update, UserError, Var, WithFields, Without, Year, Zip, ar, aropt, err, funcWrap, hasImplicit, intsp, intspallargs, kved, net, protoTermType, rethinkdb, shouldWrap, translateBackOptargs, translateOptargs, util, varar,
  __slice = [].slice,
  ...
  TermBase.prototype.run = function(connection, options, callback) {
    ...
    try {
      for (key in options) {
        ...
        if (key !== 'useOutdated' && key !== 'noreply' && key !== 'timeFormat' && key !== 'profile' && key !== 'durability' && key !== 'groupFormat' && key !== 'binaryFormat' && key !== 'batchConf' && key !== 'arrayLimit') {
    ...
    if (options.noreply === true || typeof callback === 'function') {
      try {
        return connection._start(this, callback, options);
      } catch (_error) {
        e = _error;
        if (typeof callback === 'function') {
          return callback(e);
      ...
      return new Promise((function(_this) {
        return function(resolve, reject) {
          ...
          try {
            return connection._start(_this, callback, options);
          } catch (_error) {
            e = _error;
            return callback(e);
          }
...
RDBVal = (function(_super) {
  ...
  RDBVal.prototype.changes = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return (function(func, args, ctor) {
      ctor.prototype = func.prototype;
      var child = new ctor, result = func.apply(child, args);
      return Object(result) === result ? result : child;
    })(Changes, [{}, this].concat(__slice.call(args)), function(){});
  };
  ...
  RDBVal.prototype.map = function() {
    ...
    return (function(func, args, ctor) {
      ...
      var child = new ctor, result = func.apply(child, args);
      return Object(result) === result ? result : child;
    })(Map, [{}, this].concat(__slice.call(args.map(funcWrap))), function(){});
  };
  ...
  RDBVal.prototype.min = function() {
    ...
    return (function(func, args, ctor) {
      ...
      var child = new ctor, result = func.apply(child, args);
      return Object(result) === result ? result : child;
    })(Min, [{}, this].concat(__slice.call(args.map(funcWrap))), function(){});
  };
  ...
  RDBVal.prototype.max = function() {
    ...
    return (function(func, args, ctor) {
      ...
      var child = new ctor, result = func.apply(child, args);
      return Object(result) === result ? result : child;
    })(Max, [{}, this].concat(__slice.call(args.map(funcWrap))), function(){});
  };
...
ConcatMap = (function(_super) {
  ...
  ConcatMap.prototype.tt = protoTermType.CONCATMAP;
...
OrderBy = (function(_super) {
  ...
  OrderBy.prototype.tt = protoTermType.ORDERBY;
...
TypeOf = (function(_super) {
  ...
  TypeOf.prototype.tt = protoTermType.TYPEOF;
...
ForEach = (function(_super) {
  ...
  ForEach.prototype.tt = protoTermType.FOREACH;
